...
public class GameManager : IPresistentSingleton<GameManager>
{
    ...
    {
        print("Começa");
            goblinPrefab = Resources.Load<GameObject>("Prefabs/PrefabsInimigos/GoblinPrefab");
            ...
            Inimigo goblinScript = new Inimigo();
            print("goblinCriatura.DisPersegue"+goblinCriatura.DisPersegue);
